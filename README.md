...
- [Week 118: Bildschirmzeit](https://kevingimbel.de/blog/week-118-bildschirmzeit)
- [Week 117: digital hardcore again?](https://kevingimbel.de/blog/week-117-digital-hardcore-again)
...
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([prometheus-nginx-exporter-1.20.6](https://github.com/prometheus-community/helm-charts/releases/tag/prometheus-nginx-exporter-1.20.6)) - Prometheus community Helm charts
- [tauri-apps/wry](https://github.com/tauri-apps/wry) ([wry-v0.54.4](https://github.com/tauri-apps/wry/releases/tag/wry-v0.54.4)) - Cross-platform WebView library in Rust for Tauri.
- [stackitcloud/stackit-cli](https://github.com/stackitcloud/stackit-cli) ([v0.56.0](https://github.com/stackitcloud/stackit-cli/releases/tag/v0.56.0)) - A command-line interface to manage STACKIT resources
- [j178/prek](https://github.com/j178/prek) ([v0.3.6](https://github.com/j178/prek/releases/tag/v0.3.6)) - ⚡ Better `pre-commit`, re-engineered in Rust
