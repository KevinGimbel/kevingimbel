...
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([prometheus-yet-another-cloudwatch-exporter-0.40.3](https://github.com/prometheus-community/helm-charts/releases/tag/prometheus-yet-another-cloudwatch-exporter-0.40.3)) - Prometheus community Helm charts
- [j178/prek](https://github.com/j178/prek) ([v0.3.0](https://github.com/j178/prek/releases/tag/v0.3.0)) - ⚡ Better `pre-commit`, re-engineered in Rust
