...
- [j178/prek](https://github.com/j178/prek) ([v0.4.0](https://github.com/j178/prek/releases/tag/v0.4.0)) - ⚡ A fast Git hook manager written in Rust, designed as a drop-in alternative to pre-commit, reimagined.
- [stackitcloud/stackit-cli](https://github.com/stackitcloud/stackit-cli) ([v0.62.0](https://github.com/stackitcloud/stackit-cli/releases/tag/v0.62.0)) - A command-line interface to manage STACKIT resources
