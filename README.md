...
- [j178/prek](https://github.com/j178/prek) ([v0.4.14](https://github.com/j178/prek/releases/tag/v0.4.14)) - ⚡ A fast Git hook manager written in Rust, designed as a drop-in alternative to pre-commit, reimagined.
- [zilliztech/milvus-operator](https://github.com/zilliztech/milvus-operator) ([v1.3.8](https://github.com/zilliztech/milvus-operator/releases/tag/v1.3.8)) - The Kubernetes Operator of Milvus. 
