...
- [j178/prek](https://github.com/j178/prek) ([v0.5.1](https://github.com/j178/prek/releases/tag/v0.5.1)) - ⚡ A fast Git hook manager written in Rust, designed as a drop-in alternative to pre-commit, reimagined.
